...
public class DubboProtocolTest {
    ...
    public void testDemoProtocol() throws Exception {
        ...
        service = proxy.getProxy(protocol.refer(DemoService.class, URL.valueOf("dubbo://127.0.0.1:9020/" + DemoService.class.getName() + "?codec=exchange").addParameter("timeout", 100000l)));
